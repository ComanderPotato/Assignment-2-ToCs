...
public class SyntacticAnalyser {
	...
	public static ParseTree parse(List<Token> tokens) throws SyntaxException {
		...
		List<Symbol> rule2p2 = new LinkedList<>(Arrays.asList(TreeNode.Label.epsilon));
		...
		List<Symbol> rule17p2 = new LinkedList<>(Arrays.asList(TreeNode.Label.charexpr));
		...
		List<Symbol> rule19p2 = new LinkedList<>(Arrays.asList(TreeNode.Label.epsilon));
		...
		List<Symbol> rule20p2 = new LinkedList<>(Arrays.asList(TreeNode.Label.boollog));
		...
		List<Symbol> rule23p2 = new LinkedList<>(Arrays.asList(Token.TokenType.TRUE));
		rules.put(new Pair(TreeNode.Label.relexpr, Token.TokenType.TRUE), rule23p2);

		List<Symbol> rule23p3 = new LinkedList<>(Arrays.asList(Token.TokenType.FALSE));
		...
		List<Symbol> rule24p2 = new LinkedList<>(Arrays.asList(TreeNode.Label.epsilon));
